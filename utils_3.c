...
/*   Updated: 2022/05/08 18:40:32 by rmerzak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print(t_data *data, char *str, int indexOfPhilo)
{
    ...
    if (!data->die)
    {
        printf("%lld %d %s\n", ft_time() - data->beginning_time, indexOfPhilo + 1, str);
    }
...
void *ft_routine(void *philo)
{
    ...
    while (!data->die)
    {
        ...
        usleep(data->time_to_sleep * 10000);
...
void		ft_check_eat(t_data *data, t_philosopher *philo)
{
    ...
    i = 0;
    while (data->number_of_times_each_philosopher_must_eat > 0 && i < data->nbrOfPhilo && philo[i].nbEat > data->number_of_times_each_philosopher_must_eat)
        i++;
